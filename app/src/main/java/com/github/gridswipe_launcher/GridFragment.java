...
public class GridFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        lv.setHorizontalSpacing(convertDpToPixels(17, getActivity()));
        lv.setVerticalSpacing(convertDpToPixels(0, getActivity()));
    ...
    public void setGridAdapter(ListAdapter adapter) {
        ...
        if (mGrid != null) {
            ...
            if (!mGridShown && !hadAdapter)
                // The grid was hidden, and previously didn't have an adapter.
    ...
    private void ensureGrid() {
        ...
        if (mAdapter != null) {
            ...
            // Starting without an adapter, so assume the data won't
            // be available right away and start with the progress indicator.
            if (mProgressContainer != null)
